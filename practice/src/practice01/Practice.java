...
public class Practice {
	...
	public static void main(String[] args) {
		...
		System.out.println("<08/01 문제>");
		
		
		System.out.println("[조건문 문제 - 비밀번호 맞추기]");
		//비밀번호가 “1111” 일 때
		...
		System.out.println("[조건문 문제 - 월 일수 출력하기]");
		...
		System.out.println("[반복문 문제-while/ do while]");
		...
		System.out.println("[조건문과 반복문 - 교통카드 시스템 만들기]");
		//card 안에 현재의 잔액이 들어있다, 지하철을 탈 때 1호선 요금은 1300원이다.
		//아래와 같이 출력될 수 있게 코드를 작성하세요.
		int card = 3000;
		int pay =1300;
		...
		while (getSubway == 1) {
			if (card >= pay) {
				card -= pay;
				System.out.println("탑승하였습니다. 현재 잔액은 "+card+"원입니다");
			} 
			else {
